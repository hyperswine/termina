defmodule TerminalphxWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TerminalphxWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TerminalphxWeb.Gettext, "errors", msg, opts)
    end
  end
